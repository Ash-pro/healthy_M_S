...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-dNameSalaries">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.salary.fields.d_name') }}
                        </th>
                        <th>
                            {{ trans('cruds.salary.fields.d_salary') }}
                        </th>
                        <th>
...
@endcan
  ...
  let table = $('.datatable-dNameSalaries:not(.ajaxTable)').DataTable({ buttons: dtButtons })
