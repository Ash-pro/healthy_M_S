...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-PharmacistSalary">
                <thead>
                    <tr>
                        <th width="10">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search">
                                ...
                                @foreach($pharmacists as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-PharmacistSalary:not(.ajaxTable)').DataTable({ buttons: dtButtons })
