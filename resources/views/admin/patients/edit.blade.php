    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.patients.update", [$patient->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text" name="address" id="address" value="{{ old('address', $patient->address) }}" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Patient::CHRONIC_DISEASES_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('chronic_diseases') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="chronic_diseases_{{ $key }}" name="chronic_diseases" value="{{ $key }}" {{ old('chronic_diseases', $patient->chronic_diseases) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('notes') ? 'is-invalid' : '' }}" name="notes" id="notes">{!! old('notes', $patient->notes) !!}</textarea>
                @if($errors->has('notes'))
                    <div class="invalid-feedback">
                        {{ $errors->first('notes') }}
                    </div>
