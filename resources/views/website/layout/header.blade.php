...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets')}}/assets/css/templatemo.css">
    ...
    <div class="container text-light">
        <div class="w-100 d-flex justify-content-between">
            <div>
                ...
                <a class="navbar-sm-brand text-light text-decoration-none" href="mailto:khaled@gmail.com">HMS@gmail.com</a>
                <i class="fa fa-phone mx-2"></i>
                <a class="navbar-sm-brand text-light text-decoration-none" href="tel:0598111222">0598111222</a>
            </div>
            <div>
...
<!-- Header -->
<nav class="navbar navbar-expand-lg navbar-light shadow" dir="rtl">
    <div class="container d-flex justify-content-between align-items-center" >

        <a class="navbar-brand text-success logo h1 align-self-center" href="{{route('about')}}">
